...
of inputs, r.g.~an \icode{int} or a \icode{float} value. Each of these types requires specific treatment in data
...
\begin{figure}[h]
\lstinputlisting[xrightmargin=.0\textwidth,
xleftmargin=.05\textwidth,frame=single]{\demoCodeDir/ALDDynamicOp-parameter.snippet}
...
Consider two parameters \icode{width} and \icode{height} which should adhere a given aspct ratio.
