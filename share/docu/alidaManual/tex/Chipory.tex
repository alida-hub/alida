...
\begin{figure}
\begin{center}
{\framebox{\includegraphics[clip, trim= 520 90 50 70, width=0.4\textwidth]{analyzeData-edited}}}
...
\icode{ALDClusterExpeiment} has been uncollapsed.}
\end{center}
\end{figure}
...
where the operators \icode{ALDClusterExperiment}  and \icode{NormalizeExperiment}
have been collapsed.
...
If we uncollapse the operator \icode{ALDClusterExperiment}
...
\icode{ALDClusterExperiment} and \icode{SummarizeClusters}.
}
\end{center}
\end{figure}
...
yellow.
In our example this is the output port \icode{'summaryOfExperiments'} of the
operator \icode{AnalyzeExperiment}.
