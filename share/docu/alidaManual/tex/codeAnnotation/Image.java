...
public class Image extends ALDData {

	private boolean verbose = true;

	public Image() throws ALDOperatorException {
		// we should also give the data port the properties we want to be known
		// in the operator (node) DAG

		//setProperty( "nix", "was");
		setProperty( "xsize", 512);
		setProperty( "ysize", 512);
	}

	public Image( String filename) throws ALDOperatorException {
		// we should also give the data port the properties we want to be known
		// in the operator (node) DAG
