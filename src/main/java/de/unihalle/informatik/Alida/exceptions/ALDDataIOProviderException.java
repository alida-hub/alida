...
public class ALDDataIOProviderException extends ALDDataIOException {
	 ...
	 */
	public ALDDataIOProviderException(ALDDataIOProviderExceptionType t, 
																		String c) {
		this.type= t;
		this.comment= c;
	}
	...
	public String getIdentString() {
		...
		case OBJECT_TYPE_ERROR:
			return typeID + ": object type error!";
		case OBJECT_INSTANTIATION_ERROR:
			return typeID + ": intantiation error!";
		case FILE_IO_ERROR:
			return typeID + ": file I/O error!";
		case INVALID_GUI_ELEMENT:
			return typeID + ": invalid gui element!";
